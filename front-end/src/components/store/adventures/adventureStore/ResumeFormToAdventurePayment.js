...
import { postDataCheckOutAdventure } from '../../../../redux/actions/checkoutsActions';
...
class ResumeFormToAdventurePayment extends Component {

    handleSubmit = (event) => {
        event.preventDefault();
        
        // object to extract data from redux
        const {
...
export default connect(mapStateToProps,mapActionsToProps)(withStyles(styles)(ResumeFormToAdventurePayment));