...
class AddressBillingFormToAdventurePayment extends Component {
...
export default connect(mapStateToProps,mapActionsToProps)(withStyles(styles)(AddressBillingFormToAdventurePayment));
