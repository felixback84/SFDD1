...
class CreditCardFormToAdventurePayment extends Component {
    constructor(){
        super();
        this.state = {
            number: '',
...
export default connect(mapStateToProps,mapActionsToProps)(withStyles(styles)(CreditCardFormToAdventurePayment));
