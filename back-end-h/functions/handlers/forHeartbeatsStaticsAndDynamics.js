...
exports.detectGPSCoordsProximityRangeForStaticsAndDynamics = (req,res) => {
    // profile of dynamic
    let objProfileOfDynamic = req.body.objProfileOfDynamic
    ...
    db  
        ...
        .then(()=>{
            ...
            for(let i = 0; i < coordsInLiveDataSets.length; i++){
                ...
                dataWithMatches = coordsInLiveDataSets.coords,
                dataWithMatches = coordsInLiveDataSets.profileToMatch
                // data to pass
                let argz = {
                    statics: coordsInLiveDataSets[i],
                    dynamics: objProfileOfDynamic
                };
                // run it
