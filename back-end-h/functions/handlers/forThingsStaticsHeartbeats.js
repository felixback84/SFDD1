...
// post coords command in staticheartbeat things
exports.staticHeartbeatPostCoordsCommand = async (req, res) => {
    // req data
    const thingId = req.params.thingId;
    const coordsValues = {...req.body};
    // print
    console.log(coordsValues)
    // to string
    const string = JSON.stringify(coordsValues);
    // global vars
    const cloudRegion = 'us-central1';
    const deviceId = thingId;
    const commandMessage = string;
