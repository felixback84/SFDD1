...
class ProductsResultsSearchingModeFour extends Component {
...
export default connect(mapStateToProps)(withStyles(componentStyles)(ProductsResultsSearchingModeFour));
