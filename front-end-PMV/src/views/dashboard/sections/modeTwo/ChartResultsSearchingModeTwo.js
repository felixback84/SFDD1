...
class ChartResultsSearchingModeTwo extends Component {
...
export default connect(mapStateToProps)(withStyles(componentStyles)(ChartResultsSearchingModeTwo));
