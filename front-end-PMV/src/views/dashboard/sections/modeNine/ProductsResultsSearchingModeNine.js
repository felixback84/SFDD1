...
import SwitchToMarkTop5ProductsTempsResultsModeNine from '../../components/modeNine/SwitchToMarkTop5ProductsTempsResultsModeNine';
...
const ContentRow = (props) => {
	...
	// print
	console.log(`data products modeNine from server res: ${JSON.stringify(data)}`)
	// arr to cells
    const arrayCells = []
	
	// loop over top5Products	
		...
		arrayCells.push(
			...
			>	
                ...
                <TableCell classes={{ root: classes.tableCellRoot }}>
                    ...
                    <SwitchToMarkTop5ProductsTempsResultsModeNine
...
class ProductsResultsSearchingModeNine extends Component {
...
export default connect(mapStateToProps)(withStyles(componentStyles)(ProductsResultsSearchingModeNine));
