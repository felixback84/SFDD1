...
// components
import DataFrameSelectedProductModeNine from "../../components/modeNine/DataFrameSelectedProductModeNine"
import DataFrameSelectedProductLiveModeNine from "../../components/modeNine/DataFrameSelectedProductLiveModeNine"
// Redux stuff
...
class ProductsResultsSelectedItemsSearchingModeNine extends Component {
                ...
                <Card classes={{ root: classes.cardRoot }}>
                    ...
                    </CardHeader>  
                    {
                        loading === false && this.props.top5ProductListener.length === 0 ? 
                            <>
                                <Grid container>
                                    <DataFrameSelectedProductModeNine
                                        data={
                            ...
                            <> 
                                <Grid container>
                                    <DataFrameSelectedProductLiveModeNine
...
export default connect(mapStateToProps)(withStyles(useStyles)(ProductsResultsSelectedItemsSearchingModeNine))
