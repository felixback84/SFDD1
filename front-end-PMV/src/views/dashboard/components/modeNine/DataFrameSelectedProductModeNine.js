...
class DataFrameSelectedProductModeNine extends Component {
    ...
    arrTop5Products(arrTop5Products,classes){
        ...
        arrTop5Products.map((arrTop5Product,i)=>{
            // print
            console.log(`arrTop5Product: ${JSON.stringify(arrTop5Product)}`)
            // arr push
            arr.push( 
                <GridItem xs={4}>
...
export default connect(mapStateToProps)(withStyles(useStyles)(DataFrameSelectedProductModeNine))
