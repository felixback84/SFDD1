...
class DataFrameSelectedProductLiveModeNine extends Component {
...
export default connect(mapStateToProps)(withStyles(useStyles)(DataFrameSelectedProductLiveModeNine))
