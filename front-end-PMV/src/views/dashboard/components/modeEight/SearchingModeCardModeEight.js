...
import SearchingModeSwitcherEight from "./SearchingModeSwitcherEight"
// Redux stuff
import { connect } from 'react-redux'

// cards
const SearchingModeCardModeEight = (props) => {
  // styles
	const theme = useTheme()
	// color class
	const colorClass = new ColorEngine()
	// card markup
	const modeCardMarkupEight = (data) => {
		return (
			<>
				<CardStats
...
export default connect(mapStateToProps)(SearchingModeCardModeEight)