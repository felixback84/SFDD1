...
import MarkerDynamicModeEight from './MarkerDynamicModeEight'
import MarkerStaticsModeEight from './MarkerStaticsModeEight'
// Redux stuff
import { connect } from 'react-redux';
import { heartbeatThingSyncDataLiveDB } from '../../../../redux/actions/heartbeatUIActions'


class GoogleMapModeEight extends Component {
...
export default connect(mapStateToProps,{heartbeatThingSyncDataLiveDB})(GoogleMapModeEight)
