...
import SearchingModeSwitcherTen from "./SearchingModeSwitcherTen"
// Redux stuff
import { connect } from 'react-redux'

// cards
const SearchingModeCardModeTen = (props) => {
  // styles
	const theme = useTheme()
	// color class
	const colorClass = new ColorEngine()
	// card markup
	const modeCardMarkupTen = (data) => {
		return (
			<>
				<CardStats
...
export default connect(mapStateToProps)(SearchingModeCardModeTen)