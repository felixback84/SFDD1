...
class DataFrameSelectedProductLiveModeTen extends Component {
...
export default connect(mapStateToProps)(withStyles(useStyles)(DataFrameSelectedProductLiveModeTen))
