...
import MarkerDynamicModeTen from './MarkerDynamicModeTen'
import MarkerStaticsModeTen from './MarkerStaticsModeTen'
// Redux stuff
import { connect } from 'react-redux';
import { heartbeatThingSyncDataLiveDB } from '../../../../redux/actions/heartbeatUIActions'


class GoogleMapModeTen extends Component {
...
export default connect(mapStateToProps,{heartbeatThingSyncDataLiveDB})(GoogleMapModeTen)
