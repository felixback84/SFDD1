...
import MarkerDynamicModeSix from './MarkerDynamicModeSix'
import MarkerStaticsModeSix from './MarkerStaticsModeSix'
// Redux stuff
import { connect } from 'react-redux';
import { heartbeatThingSyncDataLiveDB } from '../../../../redux/actions/heartbeatUIActions'


class GoogleMapModeSix extends Component {
...
export default connect(mapStateToProps,{heartbeatThingSyncDataLiveDB})(GoogleMapModeSix)
