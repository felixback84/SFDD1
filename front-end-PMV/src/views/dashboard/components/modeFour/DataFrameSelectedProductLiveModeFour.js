...
class DataFrameSelectedProductLiveModeFour extends Component {
...
export default connect(mapStateToProps)(withStyles(useStyles)(DataFrameSelectedProductLiveModeFour))
