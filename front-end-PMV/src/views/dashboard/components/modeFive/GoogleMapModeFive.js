...
import MarkerDynamicModeFive from './MarkerDynamicModeFive'
import MarkerStaticsModeFive from './MarkerStaticsModeFive'
// Redux stuff
import { connect } from 'react-redux';
import { heartbeatThingSyncDataLiveDB } from '../../../../redux/actions/heartbeatUIActions'


class GoogleMapModeFive extends Component {
...
export default connect(mapStateToProps,{heartbeatThingSyncDataLiveDB})(GoogleMapModeFive)
