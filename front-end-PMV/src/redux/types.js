...
export const STOP_LOADING_USER_DEVICE = 'STOP_LOADING_USER_DEVICE';
    ...
    // search geoHashes by meters --> mode 7
    export const GET_DATA_FROM_USER_STATICS_CLOSER_TO_USER_DEVICE_BY_METERS = 'GET_DATA_FROM_USER_STATICS_CLOSER_TO_USER_DEVICE_BY_METERS'
    export const STOP_GET_DATA_FROM_USER_STATICS_CLOSER_TO_USER_DEVICE_BY_METERS = 'STOP_GET_DATA_FROM_USER_STATICS_CLOSER_TO_USER_DEVICE_BY_METERS'
    ...
    // search geoHashes by meters --> mode 8
    ...
    // post in liveDataSets selected products ids after mts range search and and creation docs in top5Products
    export const POST_USER_STATIC_PRODUCTS_SELECTED_BY_USERS_AFTER_MTS_RANGE_MATCH_IN_LIVEDATASETS_AND_TOP_5_PRODUCTS = 'POST_USER_STATIC_PRODUCTS_SELECTED_BY_USERS_AFTER_MTS_RANGE_MATCH_IN_LIVEDATASETS_AND_TOP_5_PRODUCTS'
    export const STOP_POST_USER_STATIC_PRODUCTS_SELECTED_BY_USERS_AFTER_MTS_RANGE_MATCH_IN_LIVEDATASETS_AND_TOP_5_PRODUCTS = 'STOP_POST_USER_STATIC_PRODUCTS_SELECTED_BY_USERS_AFTER_MTS_RANGE_MATCH_IN_LIVEDATASETS_AND_TOP_5_PRODUCTS'

    // ---> mode 9
    // search price rage in a specific category --> before mode 9
    export const GET_DATA_FROM_USER_STATICS_PRODUCTS_CLOSER_TO_USER_DEVICE_BY_PRICE_RANGE = "GET_DATA_FROM_USER_STATICS_PRODUCTS_CLOSER_TO_USER_DEVICE_BY_PRICE_RANGE"
    export const STOP_GET_DATA_FROM_USER_STATICS_PRODUCTS_CLOSER_TO_USER_DEVICE_BY_PRICE_RANGE = "STOP_GET_DATA_FROM_USER_STATICS_PRODUCTS_CLOSER_TO_USER_DEVICE_BY_PRICE_RANGE"

    // post in liveDataSets selected products ids after price range search and creation docs in top5Products
    export const POST_USER_STATIC_PRODUCTS_SELECTED_BY_USERS_AFTER_PRICE_RANGE_MATCH_IN_LIVEDATASETS_AND_TOP_5_PRODUCTS = 'POST_USER_STATIC_PRODUCTS_SELECTED_BY_USERS_AFTER_PRICE_RANGE_MATCH_IN_LIVEDATASETS_AND_TOP_5_PRODUCTS'
    export const STOP_POST_USER_STATIC_PRODUCTS_SELECTED_BY_USERS_AFTER_PRICE_RANGE_MATCH_IN_LIVEDATASETS_AND_TOP_5_PRODUCTS = "STOP_POST_USER_STATIC_PRODUCTS_SELECTED_BY_USERS_AFTER_PRICE_RANGE_MATCH_IN_LIVEDATASETS_AND_TOP_5_PRODUCTS"
